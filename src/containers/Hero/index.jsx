...
function Hero() {
  return (
    <>
      <div
        className="pt-36 sm:pb-96 pb-80 relative bg-gradient-to-t from-slate-500/10"
        id="hero"
      >
      ...
      <div className="container">
        <div className="relative sm:-mt-80 -mt-64">
          <div className="hidden sm:block">
            <div className="after:w-24 after:h-24 after:absolute after:-top-10 after:end-10 after:bg-[url('https://coderthemes.com/prompt/images/pattern/dot5.svg')]" />
            <div className="before:w-24 before:h-24 before:absolute before:-bottom-10 before:start-10 before:bg-[url('https://coderthemes.com/prompt/images/pattern/dot2.svg')]" />
          </div>
          <div
            id="swiper_one"

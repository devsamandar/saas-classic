    ...
    <section className="overflow-hidden" id="features">
      <div className="xl:py-24 py-16">
        <div className="container">
          <Title
            title="Features"
            page="Better Management. Better performance"
            text="Start working with Prompt to manage your workforce better"
          />
          ...
          <div>
            <div className="grid lg:grid-cols-2 grid-cols-1n gap-6 items-center">
              ...
              <div className="relative order-1 lg:order-2">
                <div className="hidden sm:block">
                  <div className="after:w-20 after:h-20 after:absolute after:-top-8 after:-end-8 2xl:after:-end-8 after:bg-[url('https://coderthemes.com/prompt/images/pattern/dot2.svg')]" />
                  <div className="before:w-20 before:h-20 before:absolute before:-bottom-8 before:-start-8 before:bg-[url('https://coderthemes.com/prompt/images/pattern/dot5.svg')]" />
                </div>
                <img
